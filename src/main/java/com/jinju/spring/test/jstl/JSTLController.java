...
import com.jinju.spring.test.jstl.domain.Member;
...
public class JSTLController {
	...
	public String test02(Model model) {
		...
		// member 라고 하는 이름으로 만들어진 map이 여러 개 있다
		// 이 여러개의 map이 membership 이라는 리스트에 저장이 되고 있다.
		// 해당하는 map 들은 모두 똑같은 제너릭을 가지고 같은 키의 대응 되는 값들을 가지고 있다
		// 원래 list 는 같은 형태의 데이터를 저장하는게 정상적인 형태임
